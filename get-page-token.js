...
const USER_ACCESS_TOKEN = 'EAAV1KGANimMBP8ZA6VQZBPVLACmK3eSK7Wh0rdCgLrsTNWdE49ZATMdXMYgR9ZCo5Yix2pEKSojxGAMjZAuNV6teQZCSosvhiw1cvOJJz1C1yFUBuJGU4UfRoVV78bnm7f2bKRtFnnZCLtKDeiwgr2q3oi0wK9FQ2gYl0UosCilZAIDsfEYLASGP8WlU80NrZCPqijr4K5h6RAwEzmjK91OkvIXftwr6mc2bUZCFSxGrQpjxCZBkQZDZD';
    ...
    for (const page of pagesData.data) {
      ...
      if (igData.instagram_business_account) {
        ...
        if (testData.error) {
          ...
          console.log(`   ✅ SUCCESS! This Page Token works with Instagram API`);
          ...
          if (testData.data && testData.data.length > 0) {
            ...
            testData.data.slice(0, 3).forEach((item, index) => {
              console.log(`${index + 1}. ${item.media_type}: ${item.caption?.substring(0, 60)}...`);
            });
          }
