...
const ACCESS_TOKEN = 'EAAV1KGANimMBP5iWVZBOI4R2iRZAN9qMk14UO6HsiAlGdv1XMGbIGyXW2qLwOlY0NUJMX4sZAz0UA5cUSj97AfUYWmpJA5ZAn7qOHiWFkdiNztmHZCTINZAmTuyBRNX1KlZAfZAK8PWwu0LsbD2HhfuGjFZAQrq0ZAP7xfbvROUp25RuvY7r3cX2JGvY3uR73cgGbJwnRqwUnBiNIfVR34ZBaa2rRHleyn0SEcFHRKPSMIEckPaEgZDZD';
    ...
    for (const page of pagesData.data) {
      try {
        ...
        if (igData.instagram_business_account) {
          ...
          console.log(`   REACT_APP_INSTAGRAM_USER_ID=${igData.instagram_business_account.id}`);
          console.log('');
          ...
          if (mediaData.data && mediaData.data.length > 0) {
            console.log(`✅ Successfully fetched ${mediaData.data.length} media items!`);
            console.log('');
            ...
            console.log('⚠️  No media found or error:', mediaData.error?.message || 'Unknown');
          }
