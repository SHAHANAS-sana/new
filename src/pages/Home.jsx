          ...
          <div className="grid grid-cols-2 gap-4 max-w-3xl mx-auto mb-8">
            {instagramReels.slice(0, 2).map(reel => (
              <a
                ...
                className="group relative rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-gray-900"
              >
                {/* Instagram Embed with hover play */}
                <div className="relative w-full aspect-[9/16]">
                  <iframe
                    src={`${reel.embedUrl}?autoplay=0`}
                    className="absolute top-0 left-0 w-full h-full border-0 group-hover:opacity-100 transition-opacity"
                    allowFullScreen
                    scrolling="no"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-3">
                  <div className="flex items-center gap-2 text-white text-xs">
                    ...
                    <span className="font-medium">@alramsfurnitureshowroom</span>
                  </div>
