  ...
  return [
    {
      ...
      caption:
        'Shades of നീല that make home feel softer 💙 #AlramsFurniture #InteriorDesign #HomeDecor',
    ...
    },
    {
      ...
      caption:
        'Where laughter, love, and little dreams find their perfect space ✨ #ModernInteriors #FurnitureShowroom',
      timestamp: new Date().toISOString(),
    },
  ];
};
  ...
  return [
    {
      ...
      caption:
        'Explore our latest furniture collection - Premium designs for your home',
    },
    {
      id: 'fallback-2',
      permalink: 'https://www.instagram.com/alramsfurnitureshowroom/reels/',
