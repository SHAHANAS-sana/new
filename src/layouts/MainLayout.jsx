...
const MainLayout = ({ children }) => {
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
          ...
          <div className="border-b border-gray-200">
            <div className="flex justify-between items-center py-2 px-4 sm:px-6 lg:px-8">
              <div className="flex items-center space-x-4">
                <a href="tel:1800-123-4567" className="text-sm text-gray-600 hover:text-primary">
                  <span className="hidden sm:inline">Customer Support:</span> 1800-123-4567
                </a>
                <a href="mailto:support@smartalarms.com" className="text-sm text-gray-600 hover:text-primary hidden sm:block">
                  support@smartalarms.com
                </a>
              </div>
              <div className="flex items-center space-x-4">
                <a href="/download" className="text-sm text-gray-600 hover:text-primary">
                  Download App
                </a>
      ...
      {/* Cookie Consent */}
      <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200 p-4" id="cookie-consent">
